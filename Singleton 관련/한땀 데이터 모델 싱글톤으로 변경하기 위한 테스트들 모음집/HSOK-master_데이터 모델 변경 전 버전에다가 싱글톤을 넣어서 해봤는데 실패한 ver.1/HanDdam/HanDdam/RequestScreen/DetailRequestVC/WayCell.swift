...
class WayCell: UITableViewCell {
    ...
    @IBOutlet weak var makeHanbok: UIButton!
    @IBOutlet weak var borrowHanbok: UIButton!
    
    override func awakeFromNib() {
        super.awakeFromNib()
        // Initialization code
        setButton(buttons: [makeHanbok, borrowHanbok])
        animation(of: [makeHanbok, borrowHanbok])
    }
