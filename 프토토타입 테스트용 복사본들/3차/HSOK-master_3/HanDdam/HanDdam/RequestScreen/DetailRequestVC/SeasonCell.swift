...
class SeasonCell: UITableViewCell {
    ...
    //MARK:- IBOutlets
    @IBOutlet weak var springBtn: PPRoundRectButton!
    @IBOutlet weak var summerBtn: PPRoundRectButton!
    @IBOutlet weak var fallBtn: PPRoundRectButton!
    @IBOutlet weak var winterBtn: PPRoundRectButton!
    
    
    override func awakeFromNib() {
        super.awakeFromNib()
        // Initialization code
        setButton(buttons: [springBtn, summerBtn, fallBtn, winterBtn])
        animation(of: [springBtn, summerBtn, fallBtn, winterBtn])
    }
