...
//let bidderDummy1 = Bidder(storeName: "운현주단", phoneNumber: "123", biddingList: [biddingDummy1])
//let bidderDummy2 = Bidder(storeName: "궁전 김민지 한복", phoneNumber: "456", biddingList: [biddingDummy2])
//let bidderDummy3 = Bidder(storeName: "정현주단", phoneNumber: "789", biddingList: [biddingDummy3])
//
////사장님들 bidding Dummy Data
//let biddingDummy1 = Bidding(price: "50만원", detailOfBidding: DetailOfBidding(priceAndDiscount: "", serviceProduct: "", design: "", designImage: [], color: "", colorImage: [], detail: "", detailImage: [], note: "", noteImage: []))
